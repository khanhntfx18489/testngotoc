...
/*!
 * Generated using the Bootstrap Customizer (http://getbootstrap.com/customize/?id=7a0c9bffb5bb4f1d02167b8805faff01)
 * Config saved to config.json and https://gist.github.com/7a0c9bffb5bb4f1d02167b8805faff01
 */
if ("undefined" == typeof jQuery) throw new Error("Bootstrap's JavaScript requires jQuery"); + function(t) {
    ...
    i.VERSION = "3.3.7", i.TRANSITION_DURATION = 600, i.DEFAULTS = {
        ...
        if (this.$element.trigger(d), !d.isDefaultPrevented()) {
            ...
            }).emulateTransitionEnd(i.TRANSITION_DURATION)) : (n.removeClass("active"), s.addClass("active"), this.sliding = !1, this.$element.trigger(c)), r && this.cycle(), this
        }
    };
    var o = t.fn.carousel;
